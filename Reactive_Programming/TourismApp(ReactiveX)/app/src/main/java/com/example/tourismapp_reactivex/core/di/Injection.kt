package com.example.tourismapp_reactivex.core.di

import android.content.Context
import com.example.tourismapp_reactivex.core.data.TourismRepository
import com.example.tourismapp_reactivex.core.data.source.local.LocalDataSource
import com.example.tourismapp_reactivex.core.data.source.local.room.TourismDatabase
import com.example.tourismapp_reactivex.core.data.source.remote.RemoteDataSource
import com.example.tourismapp_reactivex.core.data.source.remote.network.ApiConfig
import com.example.tourismapp_reactivex.core.domain.repository.ITourismRepository
import com.example.tourismapp_reactivex.core.domain.usecase.TourismInteractor
