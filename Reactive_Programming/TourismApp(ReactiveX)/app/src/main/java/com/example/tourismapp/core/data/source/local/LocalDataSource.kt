package com.example.tourismapp.core.data.source.local

import com.example.tourismapp.core.data.source.local.entity.TourismEntity
import com.example.tourismapp.core.data.source.local.room.TourismDao
