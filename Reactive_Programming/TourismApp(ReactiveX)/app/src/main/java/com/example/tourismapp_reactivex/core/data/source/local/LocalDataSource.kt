package com.example.tourismapp_reactivex.core.data.source.local

import com.example.tourismapp_reactivex.core.data.source.local.entity.TourismEntity
import com.example.tourismapp_reactivex.core.data.source.local.room.TourismDao
